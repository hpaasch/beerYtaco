...
from taco_app.views import CreateAccountView, AccountProfileView, EmployeeProfileUpdateView, FoodCreateView, FoodDeleteView, CreateExtraView, FoodUpdateView
from taco_app.views import DrinkCreateView
...
urlpatterns = [
    ...
    url(r'food/delete/(?P<pk>\d+)/$', FoodDeleteView.as_view(), name='food_delete_view'),
    ...
    url(r'drink/create/$', DrinkCreateView.as_view(), name='drink_create_view'),
